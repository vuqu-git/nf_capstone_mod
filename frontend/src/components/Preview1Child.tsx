...
//
// interface Props {
//     selectedObjects: TerminDTOWithFilmDTOGallery[];
...
//
// const Preview1Child: React.FC<Props> = ({ selectedObjects, slideDuration, setShowPreview }) => {
//     const [termineForSlides, setTermineForSlides] = useState<TerminDTOWithFilmDTOGallery[]>(selectedObjects);
...
import TerminDTOWithFilmDTOGallery from "../types/TerminDTOWithFilmDTOGallery";
import styles from "./Preview.module.css";
